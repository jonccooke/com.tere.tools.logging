...
public class LogOutputStream extends OutputStream
{
	...
	/**
	 * Creates a new log output stream which logs bytes to the specified logger with
	 * the specified level.
	 *
	...
	/**
	 * Writes a byte to the output stream. This method flushes automatically at the
	 * end of a line.
	 *
	 * @param b DOCUMENT ME!
	 */
